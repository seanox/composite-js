...
(() => {
    ...
    compliant(null, window.Composer = {
         ...
         *     Serial
         *     ----
         * Serial (analogous to serial number) is an extension of the JavaScript
         * API and returns the unique identifier (UID) of an object. This serial
         * can be used to compare, map and reference a wide variety of objects.
         * The composer uses this because this cannot be changed via the markup.
         *     
